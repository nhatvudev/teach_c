...
### **Tasks**
- **Task 1**: Complete the sample code of `task 1` below for copying each value from an array (source) to another array (target). Don't write any other functions instead of main function.
    + Inpput: 
        + size of the arrays.
...
- **Task 2**: Complete the sample code of `task 2` for the same result as `task 1`. Define a function for inputing source array and a function for copying.

...
data_type array_name [size];                    // mảng 1 chiều
         hoặc 
data_type array_name[size1][size2]...[sizeN];   // mảng đa chiều
```
...
## **5.1. truyền mảng 1 chiều vào hàm**
...
## **5.2. truyền mảng đa chiều vào hàm**
...
## **6. Không nên khai báo mảng có kích thước quá lớn**
...
## **7. Mảng có chiều dài thay đổi - VLA (variable-length array)**

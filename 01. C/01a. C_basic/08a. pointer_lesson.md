...
- Một con trỏ kiểu "T" nào đấy có thể trỏ tới một biến kiểu "T", cũng có thể trỏ tới một mảng "một chiều" kiểu "T". Khi một con trỏ tham chiếu tới một mảng, ta có thể dùng toán tử [] (array subscripting) để truy cập vào một phần tử của mảng.

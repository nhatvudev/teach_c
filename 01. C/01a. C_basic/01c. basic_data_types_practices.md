# <p align="center">**C Basic Data Types & Operators**</p>
...
int main()  
{
    printf("Name : John Watson\n"); 
    printf("Date of birth : Jun 29, 1990\n"); 
    printf("Mobile : +84 903 xxx xxx\n"); 
...
## **Problem 7: 3 digits of a number**
